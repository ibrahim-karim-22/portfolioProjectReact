export const Channels = [
    ...
    },
    {
        ...
        description: `Disney XD is a dynamic and entertaining television channel that offers a wide
                    ...
                    delivers a mix of original series, movies, and shorts that cater to the diverse interests 
                    of young viewers. Whether it's exploring fantastical worlds, embarking on thrilling adventures, 
                    or laughing along with hilarious characters, Disney XD brings the magic of Disney to life in an 
...

    {
        ...
        description: `NBC News is a leading American news organization that provides comprehensive coverage of national and international news, politics, business, health,
                    ...
                    journalists and correspondents stationed around the world, NBC News delivers breaking news updates, investigative reports, and in-depth analysis to millions 
                    of viewers across the United States and beyond. Known for its credibility and dedication to providing accurate information, NBC News is a trusted source for
    ...
    },
    {
        ...
        description: `France 24 is a prominent international news channel based in Paris, France. It provides 24/7 coverage of news, 
                    ...
                    events shaping the world. France 24 aims to be a reliable source of information for viewers seeking comprehensive coverage of international
                    news and affairs.`,
        genre: ['News'],
    ...
    },
    {
        ...
        description: `Fox News is a major American cable news network known for its conservative-leaning programming. It provides 24/7
                    ...
                    outspoken conservative commentators and hosts, as well as its coverage of domestic and international affairs from a conservative perspective. 
                    Fox News is one of the most-watched cable news channels in the United States and plays a significant role in shaping public discourse on current
    ...
    },
    {
        ...
        description: `Dateline NBC" is a long-running American television newsmagazine show that primarily focuses on true crime stories, 
                    ...
                    storytelling and thorough investigative reporting, "Dateline NBC" has become a staple of television journalism, captivating audiences with 
    ...
    },
    {
        ...
        description: `Al Jazeera Arabic is a renowned international news organization based in Doha, Qatar.
                    ...
                    its comprehensive coverage of regional events and its commitment to providing diverse perspectives on complex issues. 
                    Al Jazeera Arabic reaches a broad audience across the Arab-speaking world and beyond, making it a significant player in 
    ...
    },
    {
        ...
        description: `Sky News is a British news organization renowned for its comprehensive coverage of national and
                    ...
                    and accurate reporting on significant developments shaping the world. The network also produces various programs 
                    and documentaries focusing on a wide range of topics, catering to diverse audiences. Sky News is known for its innovative
                    approach to news presentation, incorporating multimedia elements and interactive features across its platforms to engage 
                    viewers effectively. It is widely regarded as one of the leading news organizations in the United Kingdom and maintains a 
    ...
    },
    {
        ...
        description: ` NASA TV is the television service provided by the National Aeronautics and Space Administration (NASA),
                    ...
                    press conferences, educational programming, documentaries, and interviews with astronauts and scientists. NASA TV 
                    provides an inside look at the agency's missions, research, and advancements in space exploration, offering viewers 
